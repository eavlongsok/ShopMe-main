    ...
    <div class="flex justify-center my-20">
        <div class=" w-[500px] shadow-lg border-2 rounded-md border-gray-200">
           ...
           <div class="text-lg mt-5 w-5/6 mx-auto">
                ...
                <div class="text-md">
                    <input name='remember' id="remember" type="checkbox" class="mt-6 scale-150" @change="remember = !remember" value=1 />
                ...
                <p class="text-center text-[0.95rem] mb-7 mt-3">No account? <a href="/signup"><span class="font-bold hover:underline hover:cursor-pointer">Sign up</span></a> now!</p>
           </div>
       </div>
    </div>
