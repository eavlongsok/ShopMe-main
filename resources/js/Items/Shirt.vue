<template>
    <div class="w-full mx-2 my-3">
            ...
            <div  class="w-full grid grid-cols-3 my-3">
                ...
                <div v-for="promo in shirt" class="border-2 rounded-lg w-[350px] h-[450px] mx-2 my-5 bg-sky-50">
            ...
            return {
                shirt: [
                    ...
                    },
                    {
                        name: 'Man Top',
                        cost: 19.99,
                        image: 'Images/Shirt/m_t.jpg'
                    },
                    {
                        name: 'Woman Shirt 1',
                        cost: 29.99,
                        image: 'Images/Shirt/w_t_s.jpeg'
                    },
                    {
                        name: 'Woman Shirt 2',
                        cost: 9.99,
                        image: 'Images/Shirt/w_top.jpg'
                    },
                ]
            }
        }
