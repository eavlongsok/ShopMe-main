<template>
    <div class="w-full mx-2 my-3">
                <h1 class="text-2xl">Beauty</h1>
            </div>
            <div  class="w-full grid grid-cols-3 my-3">
                
                <div v-for="promo in beauty" class="border-2 rounded-lg w-[350px] h-[450px] mx-2 my-5 bg-sky-50">
            ...
            return {
                beauty: [
                    ...
                    },
                    {
                        name: 'NIVEA MEN',
                        cost: 2.99,
                        image: 'Images/Beauty/anti.jpg'
                    },
                    {
                        name: 'FOAM',
                        cost: 2.99,
                        image: 'Images/Beauty/foam.jpg'
                    },
                    {
                        name: 'VERSACE EROS',
                        cost: 139.99,
                        image: 'Images/Beauty/versace.jpg'
                    }
                ]
            }
        }
