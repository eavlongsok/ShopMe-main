<template>
    <div class="w-full mx-2 my-3">
                <h1 class="text-2xl">Chair</h1>
            </div>
            <div  class="w-full grid grid-cols-3 my-3">
                
                <div v-for="promo in chair" class="border-2 rounded-lg w-[350px] h-[450px] mx-2 my-5 bg-sky-50">
            ...
            return {
                chair: [
                    ...
                    },
                    {
                        name: 'Oak Chair',
                        cost: 9.99,
                        image: 'Images/Chair/oak_chair.jpg'
                    },
                    {
                        name: 'Office Chair',
                        cost: 19.99,
                        image: 'Images/Chair/office_chair.jpg'
                    },
                    {
                        name: 'Sofa',
                        cost: 119.99,
                        image: 'Images/Chair/sofa.jpg'
                    },
                    {
                        name: 'Soft Chair',
                        cost: 52.99,
                        image: 'Images/Chair/soft_chair.jpg'
                    }
                ]
            }
        }
